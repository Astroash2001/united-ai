...
import { ChapterFlag, MAX_MEDIA_UPLOAD_MB, transcribeVideo } from "@/services/transcription-api";
        ...
        <div className="max-w-5xl mx-auto space-y-4">
          <div className="retro-panel p-3 text-center border-b-[3px] border-[#1C1C1C]">
            ...
            <div className="mt-2 inline-block border border-[#1C1C1C] bg-[#FF9933] text-[#1C1C1C] px-3 py-1 text-[10px] font-mono font-bold shadow-[2px_2px_0px_#1C1C1C]">
              [ ⚠️ SYSTEM LIMIT: MAXIMUM VIDEO UPLOAD IS {MAX_MEDIA_UPLOAD_MB}MB ]
            </div>
          </div>
          ...
          {transcript && (
            <div className="space-y-4">
              ...
              <TranscriptPanel
                ...
                exportTitle={selectedFile?.name || "UNITED AI — VIDEO TRANSCRIPT"}
